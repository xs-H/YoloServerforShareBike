...
from utils.paths import (CONFIGS_DIR, load_yaml_config, PRETRAINED_MODELS_DIR,YOLO_SERVICE_DIR)
# from utils import log_execution_time
import argparse
import logging
from utils.utils import setup_logging, merge_configs, log_training_params, copy_checkpoint_models
# from utils import rename_log_file # 日志重命名得自己写



def parse_args():
    parser = argparse.ArgumentParser(description="基于YOLO的安全帽检测训练")
    # YOLO 核心参数
